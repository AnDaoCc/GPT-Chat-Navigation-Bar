...
(() => {
  ...
  var TEXT_IGNORED_CONTAINER_SELECTOR = [
    "script",
    "style",
    "noscript",
    "svg",
  ...
  function getPageStorageKey(settings, pageId = getPageId()) {
  ...
  async function loadSettings() {
    return normalizeSettings(await storageGet(STORAGE_SETTINGS_KEY));
  }
  function saveSettings(settings) {
    return storageSet({ [STORAGE_SETTINGS_KEY]: normalizeSettings(settings) });
  }
  function readPageStorageRecord(pageKey) {
    try {
  ...
  function getThreadWidthSettingFromPixels(widthPixels) {
  ...
  function getThreadWidthPixels(widthSetting) {
    const rem = parseFloat(window.getComputedStyle(document.documentElement).fontSize) || 16;
    return getThreadWidthRem(widthSetting) * rem;
  }
  async function readStoredRecord(settings, pageKey) {
    ...
    return storageGet(pageKey);
  }
  function applyChatTypography(settings) {
    let style = document.getElementById(CHAT_STYLE_ID);
    if (!style) {
  ...
  function getNativeMessageKey(element) {
    const candidates = [];
    ...
    addCandidate(element.closest("[id]"));
  ...
  function getNodeSessionAnchorId(element) {
  ...
  function buildNavigatorItems(favorites) {
  ...
  function makeRecordSignature(items, favorites) {
    ...
    const itemSignature = items.map((item) => `${item.id}:${item.promptPreview}:${item.answerSummary}:${item.favorite ? "1" : "0"}`).join("|");
  ...
  function ConversationNavigator() {
    ...
    const [pageId, setPageId] = (0, import_react3.useState)(getPageId);
    const pageKey = (0, import_react3.useMemo)(() => getPageStorageKey(settings, pageId), [pageId, settings]);
    const [displayOpen, setDisplayOpen] = (0, import_react3.useState)(false);
    const [isOpening, setIsOpening] = (0, import_react3.useState)(false);
    const [items, setItems] = (0, import_react3.useState)([]);
    const [query, setQuery] = (0, import_react3.useState)("");
    const [favoritesOnly, setFavoritesOnly] = (0, import_react3.useState)(false);
    const [favorites, setFavorites] = (0, import_react3.useState)({});
    const [activeId, setActiveId] = (0, import_react3.useState)(null);
    const [theme, setTheme] = (0, import_react3.useState)(detectPageTheme);
    const [resizeFrame, setResizeFrame] = (0, import_react3.useState)(null);
    const [resizingSide, setResizingSide] = (0, import_react3.useState)(null);
    ...
    (0, import_react3.useEffect)(() => {
      ...
      const routeInterval = window.setInterval(checkRoute, 1e3);
    ...
    const updateResizeFrame = (0, import_react3.useCallback)(() => {
    ...
    const toggleCollapsed = async () => {
      if (settings.collapsed) {
        ...
        openingTimerRef.current = window.setTimeout(() => {
          setIsOpening(false);
          openingTimerRef.current = void 0;
        }, 300);
      } else {
        setIsOpening(false);
        if (openingTimerRef.current) {
    ...
    const startThreadResize = (side) => (event) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "aside",
        {
          ...
          children: settings.collapsed ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelRightOpen, { size: 20, "aria-hidden": "true" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: items.length })
              ]
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cnav-panel", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cnav-header-actions", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlidersHorizontal, { size: 17, "aria-hidden": "true" })
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelRightClose, { size: 18, "aria-hidden": "true" })
                  }
                )
              ] })
            ] }),
            displayOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cnav-display-panel", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cnav-display-field cnav-language-field", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Languages, { size: 14, "aria-hidden": "true" }),
                  t.language
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "select",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cnav-controls", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { size: 17, "aria-hidden": "true" })
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { size: 16, "aria-hidden": "true" })
                }
              )
            ] }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", { className: "cnav-footer", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: cacheLabel })
            ] })
          ] })
        }
      )
